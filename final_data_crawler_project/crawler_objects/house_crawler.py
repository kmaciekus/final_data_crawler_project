...
class HouseObject:
    """
        ...
        - plot area (float): Area of the plot.
...
class HouseEstateCrawler:
    ...
    def _extract_apartment_data(self, element):
        ...
        object_plot_area=convert_to_float(element.find_element(By.CLASS_NAME, "list-AreaLot-v2 ").text) #unique
        object_state=element.find_element(By.CLASS_NAME, "list-HouseStates-v2 ").text # unique

        return HouseObject(object_address, object_url, object_price, object_area, object_plot_area, object_state)
